...
<html>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <?php echo form_open_multipart('admin/edit/'.$artikel[0]['id']);?>
            ...
            <a class="btn btn-default" href="<?php echo base_url('admin/data_artikel') ?>">Back to Data Artikel</a>
            <a class="btn btn-info" href="<?php echo base_url('admin') ?>">Back to Admin Page</a>
