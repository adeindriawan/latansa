  ...
  <div class="rounded">
    <footer id="footer" class="clear"> 
      ...
      <div class="one_third first">
        <figure class="center"><img class="btmspace-15" src="<?php echo base_url() ?>images/demo/worldmap.png" alt="">
          <figcaption><a href="#">Find Us With Google Maps &raquo;</a></figcaption>
        </figure>
      </div>
      <div class="one_third">
        <address>
        Parakansantri, Cipanas<br>
        Lebakgedong, Lebak<br>
        Banten<br>
        42372<br>
        <br>
      ...
      <div class="one_third">
        <p class="nospace btmspace-10">Ikuti perkembangan La Tansa di media sosial:</p>
        ...
        <form class="clear" method="post" action="#">
          <fieldset>
            <legend>Ingin terus mendapatkan kabar-kabar terbaru La Tansa?</legend>
            <input type="text" value="" placeholder="Masukkan Email Di Sini&hellip;">
