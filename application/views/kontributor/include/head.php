...
<head>
    <meta charset="UTF-8" />
    <title><?php if ($this->uri->segment(1) == "kontributor" && $this->uri->segment(2) == "") { ?>
        Kontributor | Dashboard
    <?php } elseif ($this->uri->segment(1) == "kontributor" && $this->uri->segment(2) == "data_blog") { ?>
        Kontributor | Data Blog
    <?php } elseif ($this->uri->segment(1) == "kontributor" && $this->uri->segment(2) == "new_blog") { ?>
        Kontributor | Buat Blog
    <?php } elseif ($this->uri->segment(1) == "kontributor" && $this->uri->segment(2) == "profil") { ?>
        Kontributor | Profil
    <?php } ?></title>
