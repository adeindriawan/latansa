	...
	<body class="padTop53 ">
		...
		<?php $this->load->view('staf/include/head'); ?>
			<div id="wrap">
									...
									<?php } else { ?>
										<?php foreach ($artikel->result_array() as $value) { ?>
											<tr>
												...
												<td style="color:#000;"><?php echo $value['username'] ?></td>
												...
												<td>
												<a href="<?php echo site_url("staf/edit_post/".$value['id']) ?>" class="btn btn-primary">
				...
				<a href="<?php echo site_url("staf/new_post") ?>" name="tambah-mitra" class="btn btn-primary">Artikel Baru</a>
