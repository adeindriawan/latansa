...
<html>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <?php echo form_open_multipart('staf/edit/'.$artikel[0]['id']);?>
            ...
            <a class="btn btn-default" href="<?php echo base_url('staf/data_artikel') ?>">Back to Data Artikel</a>
