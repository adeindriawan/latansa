                ...
                <div class="col-lg-12">
                  <div style="text-align: center;">
                    <a class="quick-btn" href="#">
                        ...
                        <span>Berita</span>
                        <span class="label label-success"><?php echo $jumlah_berita ?></span>
                    </a>
                    <a class="quick-btn" href="#">
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          function cek_notifikasi_lagi (id) {
            $.post(link + 'staf/cek_notifikasi', {id_notifikasi: id, session_id: session_id, ajax: 1}, function(data, textStatus, xhr) {
          ...
          $.post(link + 'staf/cek_notifikasi', {session_id: session_id, ajax: 1}, function(data) {
            /*optional stuff to do after success */
            if (data == "false") {
              $.gritter.add({
                title: "Notifikasi",
