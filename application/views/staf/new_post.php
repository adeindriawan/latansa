...
<html>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <?php echo form_open_multipart('staf/post');?>
            ...
            <br><input type="submit" name="submit" value="Save & Publish" id="save" class="save btn btn-primary" /> <a class="btn btn-info" href="<?php echo base_url('staf') ?>">Back To Staff Page</a>
