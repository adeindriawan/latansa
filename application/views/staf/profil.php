...
<?php $this->load->view('staf/include/menu'); ?>
<!-- MAIN WRAPPER -->
    <div id="wrap" >
          <!--PAGE CONTENT -->
          <div id="content">  
            <div class="inner" style="min-height: 700px;">
              ...
              <hr />
			<?php echo form_open_multipart("staf/edit_profil/".$profil[0]['id_staf'], array('class' => 'form-horizontal')); ?>
			...
			<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
				...
				<div class="form-group">
        			...
        			<a href="<?php echo site_url("staf") ?>" name="kembali" class="btn btn-danger">Batal</a>
				    </div>
				</div>
			</div>
