...
<html>
    <head>
        <title>Staf | Edit/Publish Blog</title>
        <meta charset="utf-8">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <?php echo form_open_multipart('staf/publish/'.$artikel[0]['id']);?>
            ...
            <a class="btn btn-default" href="<?php echo base_url('staf/data_blog') ?>">Back to Data Blog</a>
